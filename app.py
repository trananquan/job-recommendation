...
gb_classifier_job_recommendation = pickle.load(open('models/gb_classifier_job_recommendation.pkl', 'rb'))
...
def job_recommendation(resume_text):
    ...
    recommended_job = gb_classifier_job_recommendation.predict(resume_tfidf)[0]
...
def extract_skills_from_resume(text):
    ...
    skills_list = [
        ...
        'Business Development', 'Sales', 'Marketing', 'Content Marketing', 'Marketing truyền thông', 'Email Marketing',
        'SEO', 'SEM', 'PPC',
